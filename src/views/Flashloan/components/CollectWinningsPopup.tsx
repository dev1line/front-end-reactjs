...
import { useGetFlashloanStatus, useIsHistoryPaneOpen } from 'state/hooks'
import { useAppDispatch } from 'state'
import { setHistoryPaneState } from 'state/Flashloan'
...
const CollectWinningsPopup = () => {
  ...
  const Flashloantatus = useGetFlashloanStatus()
