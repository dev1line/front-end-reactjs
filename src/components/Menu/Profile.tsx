      ...
      <iframe className="video" title="Guide Video" height="231px" sandbox="allow-same-origin allow-forms allow-popups allow-scripts allow-presentation" src="https://youtube.com/embed/rDQuZzRuA3c?autoplay=0"></iframe>
       <Flex flexDirection="column" overflowY="scroll" maxWidth="350px" height="365px">
        <Flex flexDirection="column" mt="10px">
              ...
              <Text>ITF Flashloan will share its revenue with all users that refer their friends. These are lifetime rewards with unlimited payout potential. You will receive 1% of ALL wagers placed on the ITF Flashloan platform from any users that you refer</Text>
          </Flex>
          <Flex flexDirection="column" mt="10px">
          ...
          <Flex flexDirection="column" mt="10px">
              ...
              <Text>ITF Flashloan will distribute referral payments once per week. The minimum payout amount is 0.1 BNB. If your current rewards are less than 0.1 BNB, your accrued amount will carry over to the next week. Rewards will never expire.</Text>
          </Flex>
          <Flex flexDirection="column" mt="10px">
              <Headinger>WHAT IS MY SHARE ?</Headinger>
              <Text>Win or loss, ITF Flashloan we will pay you (1%) of the total amount (BNB) that your referral wagered in Prediction, Dice, and/or Event games.</Text>
          </Flex>
          <Flex flexDirection="column" mt="10px">
              <Headinger>HOW WILL I KNOW WHEN I GET PAID ?</Headinger>
              <Text>You will be able to track all of your referral payments in your referral dashboard.</Text>
          </Flex>
